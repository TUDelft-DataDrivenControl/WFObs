function [ measured ] = WFObs_s_loadmeasurements( sourcepath, datanroffset, time, noise_obs )
...
measured.u      = measured.uq + noise_obs*randn(size(measured.uq)); % Disturbed
measured.v      = measured.vq + noise_obs*randn(size(measured.vq)); % Disturbed
