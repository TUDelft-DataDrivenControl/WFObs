...
% If applicable: SOWFA with ADM(R). COMMENT OUT IF UNUSED
scriptOptions.turbOutADM = 'W:\OpenFOAM\bmdoekemeijer-2.4.0\simulationCases\ACC2019\NREL5MW_9turb_SSC_aligned_CL_deterministic\turbineOutput\20000' % ONLY IF ADM
...
meshSetup.Ny          = 48    % Number of grid points in y-direction (-)