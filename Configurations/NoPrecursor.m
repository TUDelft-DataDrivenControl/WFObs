...
sourcepath      = '..\WFSim\Data_SOWFA\NoPrecursor\2turb_60x30_lin'; % Specify location of SOWFA data (excluding backslash at the end)
datanroffset    = 00000;                                             % Numbering offset (first filenumber is datanroffset+1)
Wp.name         = 'noprecursor_2turb_60x30_lin';                     % Name of meshing (from "meshing.m")
sensors_path    = ['Setup_sensors\sensor_layouts\' ...               % Specify file with sensor (measurement) locations
                   'sensors_2turb_60x30_lin_downwind.mat']; 
